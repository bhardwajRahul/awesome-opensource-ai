...
- **[Deepnote](https://github.com/deepnote/deepnote)** ![GitHub stars](https://img.shields.io/github/stars/deepnote/deepnote?style=social) - Drop-in replacement for Jupyter with AI-first design, sleek UI, and native data integrations. Features reactive notebook execution, human-readable .deepnote YAML format, and AI agent support. Run locally in VS Code/Cursor or scale to Deepnote Cloud. Apache 2.0 licensed.
...
- **[Jupyter AI](https://github.com/jupyterlab/jupyter-ai)** ![GitHub stars](https://img.shields.io/github/stars/jupyterlab/jupyter-ai?style=social) - Open-source extension that connects AI agents to computational notebooks in JupyterLab. Supports Claude, Codex, GitHub Copilot, Gemini, Goose, and more via ACP protocol. Features native chat UI, MCP server integration, and permission-based guardrails. BSD-3-Clause licensed.
